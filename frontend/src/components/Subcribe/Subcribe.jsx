    ...
    <div className='subcribe'>
        ...
        <div class="relative flex h-10 w-full min-w-[200px] max-w-[24rem]">
            ...
            <input
                ...
                placeholder=" "outline-none transition-all duration-200 
                required
            />
